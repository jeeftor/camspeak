  ...
  {:else}
    ...
    {#if formOpen}
      <div class="rounded-lg border bg-card p-5 flex flex-col gap-3">
        ...
        <label class="flex items-center gap-2 text-sm text-muted-foreground" title="Loop count: -1 = infinite, 0 = no loop (default), N = play N+1 times (pausable via /api/pause)">
