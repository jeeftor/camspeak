...
func New(
	...
	api.POST("/describe/jobs", h.StartDescribeJob)
	api.GET("/describe/jobs/:id", h.GetDescribeJob)
	api.POST("/announce", h.Announce)
	...
	api.GET("/library/upload/jobs/:id", h.UploadJobStatus)
	...
	api.POST("/config/tts/benchmark", h.BenchmarkTTS)
	api.POST("/config/tts/benchmark/speaker", h.StartSpeakerBenchmark)
	api.GET("/config/tts/benchmark/jobs/:id", h.GetDescribeJob)
	api.DELETE("/config/tts/benchmark/jobs/:id", h.CancelSpeakerBenchmark)
